  ...
  return (
    <div className='flex p-4 items-center justify-between bg-secondary shadow-sm'>
        ...
        <ul className='hidden md:flex gap-6'>
            <li className={`hover:text-primary hover:font-bold transition cursor-pointer ${path=='/dashboard'&&'text-primary font-bold'}`}
            ...
            <li className={`hover:text-primary hover:font-bold transition cursor-pointer ${path=='/dashboard/upgrade'&&'text-primary font-bold'}`}>Upgrade</li>
